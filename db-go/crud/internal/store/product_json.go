...
func (s *StoreProductJSON) ReadAll() (p map[int]domain.Product, err error) {
	// open file
...
func (s *StoreProductJSON) WriteAll(p map[int]domain.Product) (err error) {
	// serialize
	var pr []ProductJSON
	for _, v := range p {
